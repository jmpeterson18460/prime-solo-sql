...
--The bank is giving a new customer bonus! Update all 
...
WHERE "account_balance" > '0.00' ORDER BY 
...
VALUES ('pat', 'sacramento', '300', '310', '4391839.55');

--The bank is losing money in Miami and Phoenix and needs to 
--unload low transaction customers: Delete users that reside 
